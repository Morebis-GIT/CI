...
Scenario: BulkStandardDayPartCreated message should successfully save records
	Given The data from file DayPartGroups.SalesAreas_Setup exists in database
	And The data from file DayPartGroups.Setup exists in database
	And I have BulkStandardDayPartGroupCreated message from file DayPartGroups.BulkStandardDayPartGroupCreated.Success_Request to publish
...
Scenario: BulkStandardDayPartGroupCreated message should throw exception when sales area is not found
	Given The data from file DayPartGroups.SalesAreas_Setup exists in database
	And The data from file DayPartGroups.Setup exists in database
	And I have BulkStandardDayPartGroupCreated message from file DayPartGroups.BulkStandardDayPartGroupCreated.Error_SalesAreaNotFound to publish
	When I publish message to message broker
...
Scenario: BulkStandardDayPartGroupCreated message should throw exception when demographic is not found
	Given The data from file DayPartGroups.SalesAreas_Setup exists in database
	And The data from file DayPartGroups.Setup exists in database
	And I have BulkStandardDayPartGroupCreated message from file DayPartGroups.BulkStandardDayPartGroupCreated.Error_DemographicNotFound to publish
	When I publish message to message broker
...
Scenario: BulkStandardDayPartGroupCreated message should throw exception when DayPart is not found
	Given The data from file DayPartGroups.SalesAreas_Setup exists in database
	And The data from file DayPartGroups.Setup exists in database
	And I have BulkStandardDayPartGroupCreated message from file DayPartGroups.BulkStandardDayPartGroupCreated.Error_DayPartNotFound to publish
	When I publish message to message broker
...
Scenario: BulkStandardDayPartGroupCreated message should throw validation exception for empty properties
	Given The data from file DayPartGroups.SalesAreas_Setup exists in database
	And The data from file DayPartGroups.Setup exists in database
	And I have BulkStandardDayPartGroupCreated message from file DayPartGroups.BulkStandardDayPartGroupCreated.Error_InvalidData to publish
	When I publish message to message broker
