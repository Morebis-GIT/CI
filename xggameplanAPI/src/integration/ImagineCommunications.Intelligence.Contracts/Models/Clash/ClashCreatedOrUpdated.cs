...
{
    public class ClashCreatedOrUpdated : IClashCreatedOrUpdated
    {
        public ClashCreatedOrUpdated(string parentExternalidentifier, string description, int exposureCount, string externalref, List<ClashDifference> differences)
        {
