...
{
    public class SalesAreaUpdated : ISalesAreaUpdated
    {
        ...
        public SalesAreaUpdated(int customId, string name, string shortName, string currencyCode, string baseDemographic1, string baseDemographic2,
