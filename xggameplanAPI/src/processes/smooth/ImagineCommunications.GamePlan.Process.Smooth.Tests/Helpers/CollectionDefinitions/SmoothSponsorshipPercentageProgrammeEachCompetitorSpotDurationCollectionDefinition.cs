...
{
    [CollectionDefinition("Smooth - Sponsorship - Percentage - Programme - Each competitor - Spot duration")]
    public class SmoothSponsorshipPercentageProgrammeEachCompetitorSpotDurationCollectionDefinition
