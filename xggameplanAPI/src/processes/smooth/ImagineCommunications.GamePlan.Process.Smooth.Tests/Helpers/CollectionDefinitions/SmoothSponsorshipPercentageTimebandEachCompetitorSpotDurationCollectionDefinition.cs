...
{
    [CollectionDefinition("Smooth - Sponsorship - Percentage - Timeband - Each competitor - Spot duration")]
    public class SmoothSponsorshipPercentageTimebandEachCompetitorSpotDurationCollectionDefinition
