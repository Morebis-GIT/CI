...
{
    [Collection("Smooth - Sponsorship - Flat - Programme - All competitors")]
    [Trait("Smooth", "XG10/11 Sponsorship - Flat - Programme - All competitors")]
    public class SponsorshipFlatProgrammeAllCompetitorsTests : SponsorshipRestrictionsTests
    {
        public SponsorshipFlatProgrammeAllCompetitorsTests(
        ...
        [SkippableTheory]
        [MemberData(nameof(SponsorshipTestCasesFor_Flat_Programme_AllCompetitors_SpotCount_PositiveTest))]
        internal void GivenTheSponsorshipDataIsProvidedWithCalculationTypeSetToFlatAndRestrictionLevelProgrammeForAllCompetitorsWithRestrictionTypeSetToSpotCountSmoothWillPlaceAllSpotsToMatchWithSponsorshipRules_PositiveTests(
            bool skipped,
            string code,
        ...
        [SkippableTheory]
        [MemberData(nameof(SponsorshipTestCasesFor_Flat_Programme_AllCompetitors_SpotDuration_PositiveTest))]
        internal void GivenTheSponsorshipDataIsProvidedWithCalculationTypeSetToFlatAndRestrictionLevelProgrammeForAllCompetitorsWithRestrictionTypeSetToSpotDurationSmoothWillPlaceAllSpotsToMatchWithSponsorshipRules_PositiveTests(
            bool skipped,
            string code,
            string calculationType,
            string restrictionLevel,
        ...
        [SkippableTheory]
        [MemberData(nameof(SponsorshipTestCasesFor_Flat_Programme_AllCompetitors_SpotCount_NegativeTest))]
        internal void GivenTheSponsorshipDataIsProvidedWithCalculationTypeSetToFlatAndRestrictionLevelProgrammeForAllCompetitorsWithRestrictionTypeSetToSpotCountSmoothWillPlaceAllSpotsToMatchWithSponsorshipRules_NegativeTests(
          bool skipped,
          string code,
          string calculationType,
          string restrictionLevel,
        ...
        public static IEnumerable<object[]> SponsorshipTestCasesFor_Flat_Programme_AllCompetitors_SpotCount_NegativeTest =>
            SmoothTest.LoadTestSpecificCsvFile(
                Path.Combine(
                "Sponsorship",
                "TestCaseData-Flat-Programme-AllCompetitors-SpotCount-NegativeTest.csv"
            ));

        public static IEnumerable<object[]> SponsorshipTestCasesFor_Flat_Programme_AllCompetitors_SpotCount_PositiveTest =>
            SmoothTest.LoadTestSpecificCsvFile(
                Path.Combine(
                "Sponsorship",
                "TestCaseData-Flat-Programme-AllCompetitors-SpotCount-PositiveTest.csv"
                ));
        ...
        public static IEnumerable<object[]> SponsorshipTestCasesFor_Flat_Programme_AllCompetitors_SpotDuration_PositiveTest =>
            SmoothTest.LoadTestSpecificCsvFile(
                Path.Combine(
                "Sponsorship",
                "TestCaseData-Flat-Programme-AllCompetitors-SpotDuration-PositiveTest.csv"
                ));
    }
}
