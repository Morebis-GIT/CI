...
{
    [Collection("Smooth - Sponsorship - Flat - Timeband - Each competitor - Spot duration")]
    [Trait("Smooth", "XG10/11 Sponsorship - Flat - Timeband - Each competitor - Spot duration")]
    public class SponsorshipFlatTimebandEachCompetitorSpotDurationTests : SponsorshipRestrictionsTests
    {
        public SponsorshipFlatTimebandEachCompetitorSpotDurationTests(
        ...
        [SkippableTheory]
        [MemberData(nameof(SponsorshipTestCasesFor_Flat_TimeBand_EachCompetitor_SpotDuration_PositiveTest))]
        internal void GivenTheSponsorshipDataIsProvidedWithCalculationTypeSetToFlatAndRestrictionLevelTimeBandForEachCompetitorWithRestrictionTypeSetToSpotDurationSmoothWillPlaceAllSpotsToMatchWithSponsorshipRules_PositiveTests(
            bool skipped,
            string code,
        ...
        [SkippableTheory]
        [MemberData(nameof(SponsorshipTestCasesFor_Flat_TimeBand_EachCompetitor_SpotDuration_NegativeTest))]
        internal void GivenTheSponsorshipDataIsProvidedWithCalculationTypeSetToFlatAndRestrictionLevelTimeBandForEachCompetitorWithRestrictionTypeSetToSpotDurationSmoothWillPlaceAllSpotsToMatchWithSponsorshipRules_NegativeTests(
          bool skipped,
          string code,
          string calculationType,
          string restrictionLevel,
        ...
        public static IEnumerable<object[]> SponsorshipTestCasesFor_Flat_TimeBand_EachCompetitor_SpotDuration_NegativeTest =>
            SmoothTest.LoadTestSpecificCsvFile(
                Path.Combine(
                "Sponsorship",
                "TestCaseData-Flat-TimeBand-EachCompetitor-SpotDuration-NegativeTest.csv"
                ));

        public static IEnumerable<object[]> SponsorshipTestCasesFor_Flat_TimeBand_EachCompetitor_SpotDuration_PositiveTest =>
            SmoothTest.LoadTestSpecificCsvFile(
                Path.Combine(
                "Sponsorship",
                "TestCaseData-Flat-TimeBand-EachCompetitor-SpotDuration-PositiveTest.csv"
                ));
    }
}
