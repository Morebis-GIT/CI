...
{
    [Collection("Smooth - Sponsorship - Exclusive - Timeband")]
    [Trait("Smooth", "XG10/11 Sponsorship - Exclusive - Timeband")]
    public class SponsorshipExclusiveTimebandTests : SponsorshipRestrictionsTests
    {
        public SponsorshipExclusiveTimebandTests(
