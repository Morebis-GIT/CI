...
{
    [Collection("Smooth - Sponsorship - Flat - Programme - Each competitor - Spot count")]
    [Trait("Smooth", "XG10/11 Sponsorship - Flat - Programme - Each competitor - Spot count")]
    public class SponsorshipFlatProgrammeEachCompetitorSpotCountTests
        : SponsorshipRestrictionsTests
    {
        public SponsorshipFlatProgrammeEachCompetitorSpotCountTests(
