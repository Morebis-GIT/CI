...
namespace ImagineCommunications.GamePlan.Domain.Tests.Common.Tests
{
    [TestFixture(Category = "Comparers :: AlphaNumeric")]
    public class AlphaNumericComparerTests
    {
        [TestCaseSource(nameof(_sourceProperty))]
        [Description("Compare two values using the same ordering as the StrCmpLogicalW function (shlwapi.h)")]
        ...
        private static readonly object[][] _sourceProperty = new object[][] {
