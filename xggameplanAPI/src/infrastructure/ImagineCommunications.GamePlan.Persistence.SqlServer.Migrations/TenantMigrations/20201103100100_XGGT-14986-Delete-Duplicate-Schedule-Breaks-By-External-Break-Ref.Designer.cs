...
namespace ImagineCommunications.GamePlan.Persistence.SqlServer.Migrations.TenantMigrations
{
    ...
    [Migration("20201103100100_XGGT-14986-Delete-Duplicate-Schedule-Breaks-By-External-Break-Ref")]
    partial class XGGT14986DeleteDuplicateScheduleBreaksByExternalBreakRef
    {
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Breaks.Break", b =>
                {
                    ...
                    b.HasIndex("ExternalBreakRef")
                        .IsUnique()
                        .HasFilter("[ExternalBreakRef] IS NOT NULL");
