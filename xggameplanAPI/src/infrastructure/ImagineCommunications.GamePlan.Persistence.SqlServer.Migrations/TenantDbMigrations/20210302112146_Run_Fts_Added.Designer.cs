...
namespace ImagineCommunications.GamePlan.Persistence.SqlServer.Migrations.TenantDbMigrations
{
    ...
    [Migration("20210302112146_Run_Fts_Added")]
    partial class Run_Fts_Added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Advertiser", b =>
                {
                    ...
                    b.Property<string>("TokenizedName")
                        .HasMaxLength(500)
                        .HasAnnotation("MySql:SearchSourceFields", "Name,ShortName,ExternalIdentifier");
                    ...
                    b.HasAnnotation("MySql:SearchFieldName", "TokenizedName");
                });
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.AutoBookApi.AutoBookSettings", b =>
                {
                    ...
                    b.Property<bool>("AutoDistributed");
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Breaks.Break", b =>
                {
                    ...
                    b.HasIndex("SalesAreaId", "ScheduledDate", "CustomId", "BreakType", "Duration", "Avail", "OptimizerAvail", "Optimize", "ExternalBreakRef", "Description", "ExternalProgRef", "PositionInProg")
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Campaigns.Campaign", b =>
                {
                    ...
                    b.Property<string>("SearchTokens")
                        .HasMaxLength(500)
                        .HasAnnotation("MySql:SearchSourceFields", "Name,CampaignGroup,ExternalId,BusinessType");
                    ...
                    b.HasAnnotation("MySql:SearchFieldName", "SearchTokens");
                });
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Clash", b =>
                {
                    ...
                    b.Property<string>("TokenizedName")
                        .HasMaxLength(500)
                        .HasAnnotation("MySql:SearchSourceFields", "Externalref,Description");
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Passes.Pass", b =>
                {
                    ...
                    b.Property<string>("TokenizedName")
                        .HasMaxLength(500)
                        .HasAnnotation("MySql:SearchSourceFields", "Id,Name");
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Passes.PassSalesAreaPriorityCollection", b =>
                {
                    ...
                    b.Property<bool>("AreTimesRetained");
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Products.Product", b =>
                {
                    ...
                    b.Property<string>("TokenizedName")
                        .HasMaxLength(500)
                        .HasAnnotation("MySql:SearchSourceFields", "Externalidentifier,Name");
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.ProgrammeDictionary", b =>
                {
                    ...
                    b.ToTable("ProgrammeDictionaries");
                });
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Programmes.Programme", b =>
                {
                    ...
                    b.Property<int>("ProgrammeDictionaryId");
                    ...
                    b.HasIndex("ProgrammeDictionaryId");
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Programmes.ProgrammeCategoryLink", b =>
                {
                    b.Property<Guid>("ProgrammeId");

                    b.Property<int>("ProgrammeCategoryId");

                    b.HasKey("ProgrammeId", "ProgrammeCategoryId");

                    b.HasIndex("ProgrammeCategoryId");

                    b.ToTable("ProgrammeCategoryLinks");
                });
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Runs.LandmarkRunQueue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Runs.Run", b =>
                {
                    ...
                    b.Property<bool?>("IncludeEfficiencyFactor");
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Runs.RunLandmarkScheduleSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<bool>("SendToLandmarkAutomatically");
                    ...
                    b.ToTable("RunLandmarkScheduleSettings");
                });
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Runs.RunScheduleSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.ScenarioCampaignFailure", b =>
                {
                    ...
                    b.Property<string>("PassesEncounteringFailure")
                        .HasMaxLength(128);
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.ScenarioResults.ScenarioCampaignResult", b =>
                {
                    ...
                    b.Property<int>("PassThatDelivered100Percent");
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Smooth.Configuration.BestBreakFactorEntities.BestBreakFactorGroupRecord", b =>
                {
                    ...
                    b.Property<bool?>("SpotsCriteriaHasBreakRequest");

                    b.Property<bool?>("SpotsCriteriaHasFIBORLIBRequests");

                    b.Property<bool?>("SpotsCriteriaHasSponsoredSpots");
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.TenantSettings.TenantSettings", b =>
                {
                    ...
                    b.Property<string>("SystemLogicalDate");
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Programmes.Programme", b =>
                {
                    ...
                    b.HasOne("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.ProgrammeDictionary", "ProgrammeDictionary")
                        .WithMany()
                        .HasForeignKey("ProgrammeDictionaryId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Programmes.ProgrammeCategoryLink", b =>
                {
                    b.HasOne("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Programmes.ProgrammeCategory", "ProgrammeCategory")
                        .WithMany()
                        .HasForeignKey("ProgrammeCategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Programmes.Programme", "Programme")
                        .WithMany("ProgrammeCategoryLinks")
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Runs.RunLandmarkScheduleSettings", b =>
                {
                    b.HasOne("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.RunType", "RunType")
                        .WithOne("RunLandmarkScheduleSettings")
                        .HasForeignKey("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Runs.RunLandmarkScheduleSettings", "RunTypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Runs.RunScheduleSettings", b =>
                {
                    b.HasOne("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Runs.Run", "Run")
                        ...
                        .HasForeignKey("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Runs.RunScheduleSettings", "RunId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Schedules.ScheduleProgramme", b =>
                {
                    b.HasOne("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Programmes.Programme", "Programme")
                        .WithOne("ScheduleProgramme")
                        .HasForeignKey("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Schedules.ScheduleProgramme", "ProgrammeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Schedules.Schedule", "Schedule")
                        .WithMany("Programmes")
                        .HasForeignKey("ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Campaigns.CampaignEndBreakRequirementItem", b =>
                {
                    b.HasOne("ImagineCommunications.GamePlan.Persistence.SqlServer.Entities.Tenant.Campaigns.CampaignBreakRequirement")
                        ...
                        .HasConstraintName("FK_CampaignBreakRequirementItems_CampaignBreakRequirements_Cam~1")
                        .OnDelete(DeleteBehavior.Cascade);
                });
