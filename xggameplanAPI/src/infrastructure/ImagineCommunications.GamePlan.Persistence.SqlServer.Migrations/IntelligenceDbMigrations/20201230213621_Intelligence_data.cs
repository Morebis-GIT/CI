...
{
    public partial class Intelligence_data : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {

            migrationBuilder.Sql(@"
                DELETE FROM MessageEntityTypes;");

            migrationBuilder.Sql(@"
                INSERT INTO `MessageEntityTypes` (Id, Name, Description) VaLUES 
            ...
            migrationBuilder.Sql("TRUNCATE table MessageTypes;");

            migrationBuilder.Sql(@"INSERT INTO `MessageTypes` (Id, Priority, Name, Description, MessageEntityTypeId)
             VaLUES
            ...
            ('IClashTruncated',5,'Clash Truncated', NULL, 5)");
