...
namespace ImagineCommunications.GamePlan.Domain.XUnit.Tests.Common.Tests.Extensions.Tests
{
    public static class GenericSortTestData
    {
        ...
        public static readonly IEnumerable<object[]> SortByDefaultComparerData = new[]{
            new object[]
            {
        ...
        public static readonly IEnumerable<object[]> SortByCustomComparerData = new[]{
            new object[]
            {
        ...
        public static readonly IEnumerable<object[]> SortMultipleFieldsByDefaultComparerData = new[]{
            new object[]
            {
        ...
        public static readonly IEnumerable<object[]> SortMultipleFieldsByCustomComparerData = new[]{
            new object[]
            {
                 new List<(string,string, IComparer<object>)>(){
                     ("Id", "asc", null),
