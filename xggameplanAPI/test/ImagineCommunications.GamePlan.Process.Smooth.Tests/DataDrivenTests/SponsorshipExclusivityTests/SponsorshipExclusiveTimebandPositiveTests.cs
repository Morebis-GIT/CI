...
{
    [Collection(nameof(SmoothSponsorshipExclusiveTimebandPositiveCollectionDefinition))]
    [Trait("Smooth", "XG10/11 Sponsorship - Exclusive - Timeband")]
    public class SponsorshipExclusiveTimebandPositiveTests
        : SponsorshipRestrictionsTests
    {
        public SponsorshipExclusiveTimebandPositiveTests(
        ...
        [SkippableTheory]
        [MemberData(nameof(SponsorshipTestCasesFor_CalculationTypeExclusive_RestrictionLevelTimeBand_PositiveTests))]
        internal void
            GivenTheSponsorshipDataIsProvidedWithCalculationTypeSetToExclusiveAndRestrictionLevelTimeBandSmoothWillPlaceAllSpotsToMatchWithSponsorshipRules_PositiveTests(
            bool skipped,
            string code,
        ...
        public static IEnumerable<object[]> SponsorshipTestCasesFor_CalculationTypeExclusive_RestrictionLevelTimeBand_PositiveTests =>
            SmoothTest.LoadTestSpecificCsvFile(
                Path.Combine(
                "Sponsorship",
                "TestCaseData-Exclusive-TimeBand-PositiveTest.csv"
            ));
    }
}
