...
{
    [Collection(nameof(SmoothSponsorshipFlatProgrammeAllCompetitorsSpotCountPositiveCollectionDefinition))]
    [Trait("Smooth", "XG10/11 Sponsorship - Flat - Programme - All competitors")]
    public class SponsorshipFlatProgrammeAllCompetitorsSpotCountPositiveTests
        : SponsorshipRestrictionsTests
    {
        public SponsorshipFlatProgrammeAllCompetitorsSpotCountPositiveTests(
            ...
            string competitors)
        {
            ...
            void CheckResults(SmoothTestResults testResults)
            {
                ...
                AssertRecommendationsAreSetWithSponsorshipRulesFor_Flat_AllCompetitors_SpotCount(
