...
{
    [Collection("Smooth - Sponsorship - Percentage - Timeband - Each competitor - Spot count")]
    [Trait("Smooth", "XG10/11 Sponsorship - Percentage - Timeband - Each competitor - Spot count")]
    public class SponsorshipPercentageTimebandEachCompetitorSpotCountTests
        : SponsorshipRestrictionsTests
    {
        public SponsorshipPercentageTimebandEachCompetitorSpotCountTests(
        ...
        [SkippableTheory]
        [MemberData(nameof(SponsorshipTestCasesFor_Percentage_TimeBand_EachCompetitor_SpotCount_PositiveTest))]
        internal void GivenTheSponsorshipDataIsProvidedWithCalculationTypeSetToPercentageAndRestrictionLevelTimeBandForEachCompetitorWithRestrictionTypeSetToSpotCountSmoothWillPlaceAllSpotsToMatchWithSponsorshipRules_PositiveTests(
            bool skipped,
            string code,
            ...
            string competitors)
        {
            ...
            void CheckResults(SmoothTestResults testResults)
            {
                ...
                AssertRecommendationsAreSetWithSponsorshipRulesFor_Percentage_EachCompetitor_SpotCount(testResults.Recommendations, expectedBreaks, sponsoredProduct, competitors, code);
            }
        }

        [SkippableTheory]
        [MemberData(nameof(SponsorshipTestCasesFor_Percentage_TimeBand_EachCompetitor_SpotCount_NegativeTest))]
        internal void GivenTheSponsorshipDataIsProvidedWithCalculationTypeSetToPercentageAndRestrictionLevelTimeBandForEachCompetitorWithRestrictionTypeSetToSpotCountSmoothWillPlaceAllSpotsToMatchWithSponsorshipRules_NegativeTests(
          bool skipped,
          string code,
          string calculationType,
          string restrictionLevel,
        ...
        public static IEnumerable<object[]> SponsorshipTestCasesFor_Percentage_TimeBand_EachCompetitor_SpotCount_NegativeTest =>
            SmoothTest.LoadTestSpecificCsvFile(
                Path.Combine(
                "Sponsorship",
                "TestCaseData-Percentage-TimeBand-EachCompetitor-SpotCount-NegativeTest.csv"
                ));

        public static IEnumerable<object[]> SponsorshipTestCasesFor_Percentage_TimeBand_EachCompetitor_SpotCount_PositiveTest =>
            SmoothTest.LoadTestSpecificCsvFile(
                Path.Combine(
                "Sponsorship",
                "TestCaseData-Percentage-TimeBand-EachCompetitor-SpotCount-PositiveTest.csv"
                ));
    }
}
