...
{
    [Collection(nameof(SmoothSponsorshipFlatProgrammeAllCompetitorsSpotCountNegativeCollectionDefinition))]
    [Trait("Smooth", "XG10/11 Sponsorship - Flat - Programme - All competitors")]
    public class SponsorshipFlatProgrammeAllSpotCountNegativeCompetitorsTests
        : SponsorshipRestrictionsTests
    {
        public SponsorshipFlatProgrammeAllSpotCountNegativeCompetitorsTests(
