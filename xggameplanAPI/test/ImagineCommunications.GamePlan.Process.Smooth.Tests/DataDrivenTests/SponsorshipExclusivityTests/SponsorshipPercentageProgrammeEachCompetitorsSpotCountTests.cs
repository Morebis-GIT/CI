...
{
    [Collection("Smooth - Sponsorship - Percentage - Programme - Each competitor - Spot count")]
    [Trait("Smooth", "XG10/11 Sponsorship - Percentage - Programme - Each competitor - Spot count")]
    public class SponsorshipPercentageProgrammeEachCompetitorsSpotCountTests
        : SponsorshipRestrictionsTests
    {
        ...
        [SkippableTheory]
        [MemberData(nameof(SponsorshipTestCasesFor_Percentage_Programme_EachCompetitor_SpotCount_PositiveTest))]
        internal void GivenTheSponsorshipDataIsProvidedWithCalculationTypeSetToPercentageAndRestrictionLevelProgrammeForEachCompetitorWithRestrictionTypeSetToSpotCountSmoothWillPlaceAllSpotsToMatchWithSponsorshipRules_PositiveTests(
            bool skipped,
            string code,
        ...
        [SkippableTheory]
        [MemberData(nameof(SponsorshipTestCasesFor_Percentage_Programme_EachCompetitor_SpotCount_NegativeTest))]
        internal void GivenTheSponsorshipDataIsProvidedWithCalculationTypeSetToPercentageAndRestrictionLevelProgrammeForEachCompetitorWithRestrictionTypeSetToSpotCountSmoothWillPlaceAllSpotsToMatchWithSponsorshipRules_NegativeTests(
          bool skipped,
          string code,
          string calculationType,
          string restrictionLevel,
        ...
        public static IEnumerable<object[]> SponsorshipTestCasesFor_Percentage_Programme_EachCompetitor_SpotCount_NegativeTest =>
            SmoothTest.LoadTestSpecificCsvFile(
                Path.Combine(
                "Sponsorship",
                "TestCaseData-Percentage-Programme-EachCompetitor-SpotCount-NegativeTest.csv"
                ));

        public static IEnumerable<object[]> SponsorshipTestCasesFor_Percentage_Programme_EachCompetitor_SpotCount_PositiveTest =>
            SmoothTest.LoadTestSpecificCsvFile(
                Path.Combine(
                "Sponsorship",
                "TestCaseData-Percentage-Programme-EachCompetitor-SpotCount-PositiveTest.csv"
                ));
    }
}
