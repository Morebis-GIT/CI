...
{
    [Collection(nameof(SmoothSponsorshipFlatProgrammeAllCompetitorsSpotDurationPositiveCollectionDefinition))]
    [Trait("Smooth", "XG10/11 Sponsorship - Flat - Programme - All competitors")]
    public class SponsorshipFlatProgrammeAllSpotDurationPositiveCompetitorsTests
