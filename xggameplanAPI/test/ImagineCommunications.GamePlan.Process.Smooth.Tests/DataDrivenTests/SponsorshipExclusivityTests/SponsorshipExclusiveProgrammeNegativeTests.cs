...
{
    [Collection(nameof(SmoothSponsorshipExclusiveProgrammeNegativeCollectionDefinition))]
    [Trait("Smooth", "XG10/11 Sponsorship - Exclusive - Programme")]
    public class SponsorshipExclusiveProgrammeNegativeTests
        : SponsorshipRestrictionsTests
    {
        public SponsorshipExclusiveProgrammeNegativeTests(
