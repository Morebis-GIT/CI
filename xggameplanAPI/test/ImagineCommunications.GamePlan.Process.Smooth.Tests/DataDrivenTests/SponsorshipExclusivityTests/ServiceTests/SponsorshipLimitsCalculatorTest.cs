...
namespace ImagineCommunications.GamePlan.Process.Smooth.Tests
{
    ...
    public class SponsorshipLimitsCalculatorTest
    {
        ...
        private static SmoothSponsorshipRunningTotals GetSampleDataForAllCompetitorsWithNoSponsoredWhenCalculationTypeIsPercentage()
        {
            var input = new SmoothSponsorshipRunningTotals();
        ...
        private static SmoothSponsorshipRunningTotals GetSampleDataForEachCompetitorWhenCalculationTypeIsPercentage()
        {
            var input = new SmoothSponsorshipRunningTotals();
        ...
        private static SmoothSponsorshipRunningTotals GetSampleDataForAllCompetitorsWithLessThanOneAvailibityForCompetitorsWhenCalculationTypeIsPercentage()
        {
            var input = new SmoothSponsorshipRunningTotals();
