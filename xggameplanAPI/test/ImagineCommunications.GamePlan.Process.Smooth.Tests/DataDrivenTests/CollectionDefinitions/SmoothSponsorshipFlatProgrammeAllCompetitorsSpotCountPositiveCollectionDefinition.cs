...
{
    [CollectionDefinition(nameof(SmoothSponsorshipFlatProgrammeAllCompetitorsSpotCountPositiveCollectionDefinition))]
    public class SmoothSponsorshipFlatProgrammeAllCompetitorsSpotCountPositiveCollectionDefinition
