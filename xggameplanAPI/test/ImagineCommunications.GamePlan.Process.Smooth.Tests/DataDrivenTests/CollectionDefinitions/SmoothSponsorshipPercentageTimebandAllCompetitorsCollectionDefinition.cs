...
{
    [CollectionDefinition("Smooth - Sponsorship - Percentage - Timeband - All competitors")]
    public class SmoothSponsorshipPercentageTimebandAllCompetitorsCollectionDefinition
