...
{
    [CollectionDefinition(nameof(SmoothSponsorshipFlatProgrammeAllCompetitorsSpotDurationNegativeCollectionDefinition))]
    public class SmoothSponsorshipFlatProgrammeAllCompetitorsSpotDurationNegativeCollectionDefinition
