...
{
    [CollectionDefinition(nameof(SmoothSponsorshipExclusiveProgrammePositiveCollectionDefinition))]
    public class SmoothSponsorshipExclusiveProgrammePositiveCollectionDefinition
