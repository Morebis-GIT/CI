...
{
    [CollectionDefinition("Smooth - Sponsorship - Flat - Timeband - Each competitor - Spot duration")]
    public class SmoothSponsorshipFlatTimebandEachCompetitorSpotDurationCollectionDefinition
