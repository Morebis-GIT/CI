...
{
    [CollectionDefinition("Smooth - Sponsorship - Flat - Programme - Each competitor - Spot duration")]
    public class SmoothSponsorshipFlatProgrammeEachCompetitorSpotDurationCollectionDefinition
