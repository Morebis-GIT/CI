...
{
    [CollectionDefinition(nameof(SmoothSponsorshipFlatProgrammeEachCompetitorSpotCountNegativeCollectionDefinition))]
    public class SmoothSponsorshipFlatProgrammeEachCompetitorSpotCountNegativeCollectionDefinition
