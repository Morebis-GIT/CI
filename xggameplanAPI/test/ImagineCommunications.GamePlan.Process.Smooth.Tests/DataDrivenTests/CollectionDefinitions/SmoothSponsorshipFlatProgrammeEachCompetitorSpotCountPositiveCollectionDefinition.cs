...
{
    [CollectionDefinition(nameof(SmoothSponsorshipFlatProgrammeEachCompetitorSpotCountPositiveCollectionDefinition))]
    public class SmoothSponsorshipFlatProgrammeEachCompetitorSpotCountPositiveCollectionDefinition
