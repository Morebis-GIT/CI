...
{
    [CollectionDefinition("Smooth - Sponsorship - Percentage - Programme - Each competitor - Spot count")]
    public class SmoothSponsorshipPercentageProgrammeEachCompetitorSpotCountCollectionDefinition
