...
{
    [CollectionDefinition(nameof(SmoothSponsorshipExclusiveProgrammeNegativeCollectionDefinition))]
    public class SmoothSponsorshipExclusiveProgrammeNegativeCollectionDefinition
