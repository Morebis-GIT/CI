...
{
    [CollectionDefinition(nameof(SmoothSponsorshipFlatProgrammeAllCompetitorsSpotCountNegativeCollectionDefinition))]
    public class SmoothSponsorshipFlatProgrammeAllCompetitorsSpotCountNegativeCollectionDefinition
