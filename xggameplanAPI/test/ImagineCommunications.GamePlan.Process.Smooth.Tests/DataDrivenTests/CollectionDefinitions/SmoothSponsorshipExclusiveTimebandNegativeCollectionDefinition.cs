...
{
    [CollectionDefinition(nameof(SmoothSponsorshipExclusiveTimebandNegativeCollectionDefinition))]
    public class SmoothSponsorshipExclusiveTimebandNegativeCollectionDefinition
