...
{
    public abstract class LibrarySalesAreaPassPriorityModelValidationTestBase<TTarget, TModel>
        where TTarget : LibrarySalesAreaPassPriorityModelValidationBase<TModel>
        where TModel : LibrarySalesAreaPassPriorityModelBase
    {
        ...
        protected virtual void AssumeTargetIsInitialised()
        {
            _target = (TTarget)Activator.CreateInstance(typeof(TTarget), _librarySalesAreaPassPrioritiesRepositoryMock.Object, _salesAreaRepositoryMock.Object);
        }
        ...
        {
            _model.SalesAreaPriorities.AddRange(CreateSalesAreaPriorities(2));
        }
