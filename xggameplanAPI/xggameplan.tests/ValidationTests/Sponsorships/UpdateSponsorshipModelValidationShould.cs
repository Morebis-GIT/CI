...
{
    [TestFixture(Category = "Validations :: Sponsorship :: UpdateSponsorshipModelValidationShould")]
    public class UpdateSponsorshipModelValidationShould
               : SponsorshipModelValidationTestBase<UpdateSponsorshipModelValidation, UpdateSponsorshipModel>
    {
        [SetUp]
        ...
        [Test(Description = "Fail When ExternalReferenceId Supplied Is Not An Existing ExternalReferenceId")]
        public async Task FailWhenExternalReferenceIdSuppliedIsNotAnExistingExternalReferenceId()
        {
            var model = AssumeValidModelIsSupplied();
        ...
        [Test(Description = "Pass When ExternalReferenceId Supplied Is An Existing ExternalReferenceId")]
        public async Task PassWhenExternalReferenceIdSuppliedIsAnExistingExternalReferenceId()
        {
            var model = AssumeValidModelIsSupplied();
