...
namespace xggameplan.AuditEvents
{
    ...
    /// </summary>
    public class AuditEventFilterModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Filters on values, respects AllFiltersRequired
        /// </summary>
        public List<AuditEventValueFilterModel> ValueFilters = new List<AuditEventValueFilterModel>();
    }
}
